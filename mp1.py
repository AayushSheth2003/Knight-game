...
def knights_game(dimensions=[],start_pos=[],display_ans=False):
    if not dimensions:
        while True:
            try:
    ...
    while True:
        ...
        if '_' not in grid_flatten:
            ...
            return (turns,dimensions,start_pos)
...
print("Player 1:")
r=input()
moves1, size1, start1 = knights_game()
print("Player 2:")
t=input()
moves2, size2, start2 = knights_game(size1)
if moves1 > moves2:
    print(f"Player 1 solved more steps ({moves1}) than Player 2 ({moves2})!")
else:
    print(f"Player 2 solved more steps ({moves2}) than Player 1 ({moves1})!")
print("Here's the solution for Player 1:")
knights_game(size1,start1,True)
print("Here's the solution for Player 2:")
knights_game(size2,start2,True)
